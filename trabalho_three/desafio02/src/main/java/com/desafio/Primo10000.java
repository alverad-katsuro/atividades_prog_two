...
public class Primo10000 {
    public static boolean isPrimeNumber(int x) {
        ...
        } else if (x == 2) { //como o numero 1 nao e considerado primo
            return true; //entao 1 especificamente retorna falso
        } else if (x > 2 && x % 2 == 0){
            return false;
        } else {
            for (int n = 3; n < x; n++) { //considerando que todo numero natural seja divisivel por 1
